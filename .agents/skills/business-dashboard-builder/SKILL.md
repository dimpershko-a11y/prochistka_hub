---
name: business-dashboard-builder
description: Use when building or improving the PRO-CHISTKA business dashboard: leads, orders, revenue, expenses, profit, employees, KPIs, filters, and monthly performance.
---

# business-dashboard-builder

## Purpose
Use when building or improving the PRO-CHISTKA business dashboard: leads, orders, revenue, expenses, profit, employees, KPIs, filters, and monthly performance.
