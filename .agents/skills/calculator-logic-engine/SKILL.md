---
name: calculator-logic-engine
description: Use when working on pure calculation logic for PRO-CHISTKA: formulas, minimum prices, coefficients, rounding, validation, and calculation test cases.
---

# calculator-logic-engine

## Purpose
Use when working on pure calculation logic for PRO-CHISTKA: formulas, minimum prices, coefficients, rounding, validation, and calculation test cases.
