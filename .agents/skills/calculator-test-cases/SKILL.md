---
name: calculator-test-cases
description: Use when creating or updating test scenarios for the PRO-CHISTKA cleaning calculator, including service type, area, clutter, minimum price, outside-KAD fee, and final estimate values.
---

# calculator-test-cases

## Purpose
Use when creating or updating test scenarios for the PRO-CHISTKA cleaning calculator, including service type, area, clutter, minimum price, outside-KAD fee, and final estimate values.
