...
description: Use when creating, changing, auditing, or testing the PRO-CHISTKA cleaning calculator, including service type, area, clutter, outside-KAD fee, minimum price, final price, lead form, and estimate flow.
---

# cleaning-calculator

## Purpose
Use when creating, changing, auditing, or testing the PRO-CHISTKA cleaning calculator, including service type, area, clutter, outside-KAD fee, minimum price, final price, lead form, and estimate flow.
