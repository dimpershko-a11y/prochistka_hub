---
name: crm-orders-module
description: Use when building or improving the PRO-CHISTKA CRM and orders module: clients, orders, statuses, managers, comments, history, and workflow.
---

# crm-orders-module

## Purpose
Use when building or improving the PRO-CHISTKA CRM and orders module: clients, orders, statuses, managers, comments, history, and workflow.
