---
name: damage-report-module
description: Use when building or improving the PRO-CHISTKA damage report module: damage records, photos, comments, responsibility, PDF, and client-facing documentation.
---

# damage-report-module

## Purpose
Use when building or improving the PRO-CHISTKA damage report module: damage records, photos, comments, responsibility, PDF, and client-facing documentation.
