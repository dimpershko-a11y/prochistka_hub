---
name: google-sheets-leads-sync
description: Use when connecting PRO-CHISTKA forms, calculator, orders, leads, expenses, employees, timesheets, or dashboard data with Google Sheets.
---

# google-sheets-leads-sync

## Purpose
Use when connecting PRO-CHISTKA forms, calculator, orders, leads, expenses, employees, timesheets, or dashboard data with Google Sheets.
