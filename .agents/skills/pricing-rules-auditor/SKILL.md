---
name: pricing-rules-auditor
description: Use when checking whether PRO-CHISTKA pricing rules, minimum prices, coefficients, and travel fees are consistent across calculator, UI, PDF, Google Sheets, and documentation.
---

# pricing-rules-auditor

## Purpose
Use when checking whether PRO-CHISTKA pricing rules, minimum prices, coefficients, and travel fees are consistent across calculator, UI, PDF, Google Sheets, and documentation.
