---
name: pro-chistka-domain
description: Use when working with PRO-CHISTKA business rules, cleaning services, prices, minimum order amounts, service area, brand style, contacts, payments, and company-specific logic.
---

# pro-chistka-domain

## Purpose
Use when working with PRO-CHISTKA business rules, cleaning services, prices, minimum order amounts, service area, brand style, contacts, payments, and company-specific logic.
